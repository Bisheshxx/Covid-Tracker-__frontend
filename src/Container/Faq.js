                ...
                <div class="faq-box2">
                    ...
                    <div className="boxes">
                        <div className="smallboxes">
                            ...
                            <div className="imagee" style={{
                                marginBottom: "1.2cm", marginLeft: "-.2cm", backgroundImage: "url(https://www.knowsleynews.co.uk/wp-content/uploads/2020/10/covid-symptoms.jpg)",
                        ...
                        <div className="smallboxes">
                            ...
                            <div className="imagee" style={{
                                marginBottom: "1.2cm", backgroundImage: "url(https://media-cdn.tripadvisor.com/media/photo-m/1280/1b/5d/5f/a8/covid-19-prevention-tips.jpg)",
                                backgroundSize: "cover"
                            }}></div>
                            <ul>
